...
private struct MoonPlacePatchOption: Identifiable {
    ...
    private var linkedPackageID: UUID? {
        // HLO ARMA is backed by the bundled patch supplied for this control.
        guard id == "v1f-head-sn" || id == "v2fx-head-sn" else { return nil }
        return UUID(uuidString: "B5830535-17F5-4965-9AF0-B7E89ABBA29D")
    }

    func matches(_ item: PatchLibraryItem) -> Bool {
        if let linkedPackageID {
            return item.id == linkedPackageID
        }
...
private enum MoonPlaceCatalog {
    static let options: [MoonPlacePatchOption] = [
        .init(id: "v1f-head-sn", title: "HLO ARMA", aliases: ["CABEZA ANTENA FFTH"], excludedAliases: [], mode: .v1f),
        ...
        .init(id: "v2fx-head-sn", title: "HLO ARMA", aliases: ["AIMBOT MOON CABEZA"], excludedAliases: [], mode: .v2fx),
                        ...
                        Button { 
                            ...
                            VStack(alignment: .leading, spacing: 12) {
                                ...
                                VStack(alignment: .leading, spacing: 4) {
                                    ...
                                    Text(isApplied ? "RESTORE ORIGINAL" : "APPLY CHANGES")
                                        .font(.caption2.weight(.bold))
